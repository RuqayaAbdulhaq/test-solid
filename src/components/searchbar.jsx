    ...
    return (
        <div class="inline-flex  items-center gap-12 rounded-full bg-white shadow-md" style={{padding: "8px"}}>
            <div class="inline-flex items-center" style={{ width: '312px', height: '28px', gap: "8px" }}>
                ...
                <div style={{ gap: '8px', fontSize: "0.81rem" , lineHeight: "1.25rem" }} class="inline-flex items-center">
                    ...
                    <input onInput={handleInputChange} type="text" style={{ width: "166px", fontSize: "0.81rem" , lineHeight: "1.25rem" }}
